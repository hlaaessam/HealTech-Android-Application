...
public class Config {
  ...
  public static final String URL_ADD= "http://192.168.1.5/connection/add.php";
 // public static final String URL_ADD_DATE_HOURS= "http://192.168.1.5/connection/addhours.php";
  ...
  public static final String URL_GET_ALL= "http://192.168.1.5/connection/get.php?id=";
  public static final String URL_GET_ALLH= "http://192.168.1.5/connection/gethis.php?id=";
  //public static final String URL_GET_ALLFD= "http://192.168.1.5/connection/getfschdoc.php?id=";
  public static final String URL_GET_ALLS= "http://192.168.1.5/connection/getsym.php?id=";
  public static final String URL_GET_ALLFS= "http://192.168.1.5/connection/getfsch.php?id=";
  public static final String URL_GET_ALLFSD= "http://192.168.1.5/connection/getfschdoc.php?id=";
  public static final String URL_DELETE= "http://192.168.1.5/connection/deleter.php?id=";
  public static final String URL_GET_TEXT= "http://192.168.1.5/connection/gettext.php?id=";
  ...
  //get patient Histoty && TEXTVIEW IN HOME(if signs are dingeres show texttview)
