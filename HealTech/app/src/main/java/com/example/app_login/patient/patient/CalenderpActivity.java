...
////////////////////////////////////////////////////////////
    ...
    private void movementFun() {
     ...
     /*   rb1 = findViewById(R.id.a);
        ...
        rb5 = findViewById(R.id.e);
        rb6 = findViewById(R.id.f);
        rb7 = findViewById(R.id.g);
        rb8 = findViewById(R.id.h);*/

        /* rb1.setText(arr_time.get(0));
        rb2.setText(arr_time.get(1));
        rb3.setText(arr_time.get(2));
        rb4.setText(arr_time.get(3));
        rb5.setText(arr_time.get(4));
        rb6.setText(arr_time.get(5));
        rb7.setText(arr_time.get(6));
        rb8.setText(arr_time.get(7));*/
   ...
   /* private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... v) {
                ...
                String s = rh.sendGetRequestParam("http://10.0.2.2/connection/get_dates.php");
    ...
    private void setmeet(String time, String date, String ID_D, String ID_P) {
        ...
        progressDialog.show();
        String url="http://192.168.1.5/connection/set_meet.php";
